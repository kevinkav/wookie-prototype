...
public class Ejb1 implements Ejb1Local {
    ...
    private my.prototype.remote.home.api.Ejb2RemoteObject ejb2Remote;
    ...
    private my.prototype.remote.home.api.Ejb2RemoteObject getEjb2Object() throws NamingException, RemoteException, CreateException {
        LOGGER.info("Ejb1: getEjb2RemoteHome....");
        InitialContext ctx = new InitialContext();
        LOGGER.info("Ejb1: Address for looking up Ejb2 =  " + ejb2Address);
        final Object iiopObject = ctx.lookup(ejb2Address);
        my.prototype.remote.home.api.Ejb2RemoteHome ejb2RemoteHome = (my.prototype.remote.home.api.Ejb2RemoteHome) PortableRemoteObject
                .narrow(iiopObject, my.prototype.remote.home.api.Ejb2RemoteHome.class);
        return ejb2RemoteHome.create();
    }
